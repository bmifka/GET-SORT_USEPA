...
# -*- coding: utf-8 -*-
"""----------------------------------------------------------------------------
This program reads the hourly Wind and scalar Variables (e.g. 
concentrations of pollutants and/or meteo variables) data from yearly files
generated from original US-EPA files with get_EPA_files.  
...
Notice: For now use it for one variable in combination with Wind data!
...
files_dir         = 'EPA_FILES/'         
fname_prefixW     = 'WIND'               
fname_prefixVars  = np.array(['PM10'])
POCs              = ["POC PM10"]

#--output
outputFile_path   = 'EPA_test.mat' # set path including the name of output file
